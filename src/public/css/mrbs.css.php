...
?>
div#dwm_header {width: 98%; float: left; margin-top: 1.0em; margin-bottom: 0.5em}
...
?>
div.celldiv {max-width: 100%; overflow: hidden; margin: 0; padding: 0; color: #000000;}
.row_labels div.celldiv {overflow: visible; background-color: #9e9e9e; }  /* we want to see the content in the row label columns */
<?php
